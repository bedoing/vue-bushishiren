    ...
    <div class="ui grid">
      ...
      <div class="eight wide column">
        <div class="ui form segment">
          ...
          <input type="submit" class="ui button" value="保存修改" @click="updatePoem">
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  route: {
    data() {
      ...
      return {
        poem: API.getPoem(poemId).then(poem => {
          poem.tags = poem.tags.join(',')
          return poem
        })
      }
    }
  ...
  methods: {
    updatePoem: function () {
      ...
      API.updatePoem(poem._id, poem).then(() => {
